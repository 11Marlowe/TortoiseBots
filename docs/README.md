...
| **Autofill missing roles for LFT dungeon runs** | Set `AiPlayerbot.RandomBotLftEnabled = 1` → [LFT Autofill](guides/living-world.md#6-automated-dungeon--battleground-queues) |
